"""
Django settings for eadproject project.
...
SECRET_KEY = '$pdachf9p=jh9gbz(jmo3q6%o!%#w-cgx^0*l9((j04k0icn1y'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['eadyoulearn.herokuapp.com', '127.0.0.1']
...
WSGI_APPLICATION = 'eadproject.wsgi.application'
